...
/**
 * @file Client.cpp
 * @brief Implementación de la lógica del cliente para el chat cifrado.
 */

 /**
  * @brief Constructor que inicializa la dirección y el puerto del servidor.
...
/**
 * @brief Destructor que cierra el socket abierto si aún está activo.
 */
Client::~Client() {
...
/**
 * @brief Intercambia claves públicas con el servidor para establecer la sesión.
 */
void
Client::ExchangeKeys() {
...
/**
 * @brief Bucle de recepción que descifra y muestra los mensajes del servidor.
 */
void 
